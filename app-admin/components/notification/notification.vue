    ...
    <div class="ml-auto pl-3">
      <div class="-mx-1.5 -my-1.5">
        <button 
          ...
          :class="[
            notificationType === 'success' ? 'bg-green-50 text-green-500 hover:bg-green-200' : null,  
            notificationType === 'info' ? 'bg-blue-50 text-blue-500 hover:bg-blue-200' : null,
            notificationType === 'error' ? 'bg-red-50 text-red-500 hover:bg-red-200' : null
          ]"
        >
