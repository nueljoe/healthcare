exports.up = function (knex) {
  return knex.schema.createTable("message_thread_participants", (table) => {
    ...
    table.timestamp("last_deleted_at").nullable(); // The last time a participant deletes a thread. This will be used for filtering messages in the thread which will be shown to the user
