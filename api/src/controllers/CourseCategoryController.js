...
export default {
    ...
    async createCategory(req, res, next) {
        ...
        try {
            ...
            if (body.parent_id) {
                const parent = await knex.first('id').from('course_categories')
    ...
    async deleteCategory(req, res, next) {
        ...
        try {
            ...
            const courseInCategory = await knex.first().from('courses')
            ...
            await knex.delete().from('course_categories').where('id', params.id);
